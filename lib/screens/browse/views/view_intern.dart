 ...
 int getScore() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      extendBody: true,
      appBar: AppBar(
        title: Text(controller.currentStudent.value.firstName + ' ' + controller.currentStudent.value.lastName,
            ...
            child: Column(
              children: [
                    ...
                    child: Stack(
                      ...
                      children: [
                        Container(
                          ...
                          child: Image(
                            image: controller.currentStudent.value.displayImage == '' ? const AssetImage('images/intern.png') : AssetImage(controller.currentStudent.value.displayImage)
                          )
                        ),
                        Padding(
                          ...
                          SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, index) {
                                return QualWidget(skill: controller.currentStudent.value.skills[index],);
                              }
                            ),
                          ),
                          Row(
                            ...
                            children: [
                              ElevatedButton(
                                onPressed: () {debugPrint(controller.currentStudent.value.email);},
                  ...
                  Padding(
                    ...
                    child: Text(controller.currentStudent.value.bio,
                        softWrap: true,
                        maxLines: 12,
